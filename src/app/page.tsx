...
export default function Home() {
  const perks = [
    ...
    },
    {
      ...
      icon: CheckCircle,
      description:
        "Every asset on our platform is verified by our team to ensure our highest quality product",
    },
    {
      name: "For the Planet",
      icon: Leaf,
  ...
  return (
    <>
      <MaxWidthWrapper>
        <div className="py-20 mx-auto text-center flex-col items-center max-w-3xl cursor-pointer">
          ...
          <p className="mt-8 text-lg max-w-prose text-muted-foreground">
            Welcome to Hippo. Every asset on our platform is verified on our
            team to ensture our highest quality digital assets
          </p>
      ...
      <ProductReel title="Brand New" href="/shop" />
